...
python src/main.py -st MA -j -d 1 --seed 2345 -m meta -di bogota -date "${i}_moving" -note "${i}_moving" -week $target_week -config_file Configs/bogota_public_transaction.json
done